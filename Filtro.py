...
mascara = cv2.imread('/Users/alonsocortes/Downloads/chicago-bears-logo-54197EE48C-seeklogo.com.png', cv2.IMREAD_UNCHANGED)  # Cargar PNG con transparencia
...
video = cv2.VideoCapture(1)  # Cambia el 0 por la ruta de un archivo de video si quieres usar un archivo
